    ...
    <>
      <div>
        <form
          ...
          className='flex my-5 mx-auto place-content-center'
        >
          <input
            className='clamp-width-input text-center px-6 py-2 outline-0 rounded-l-lg focus:outline-none'
            type='text'
          ...
          <button
            ...
            className='clamp-width-button px-6 py-2 outline-0 rounded-r-lg bg-gray-700'
          >
            search
          </button>
        </form>
